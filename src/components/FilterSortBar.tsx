...
export type ViewMode = "double" | "triple";
              ...
              <div style={{ borderBottom: "1px solid hsl(var(--border))", padding: "1rem 0" }}>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: "0.55rem" }}>
                  <CB
                    ...
                    onChange={(v) => setDraft((d) => ({ ...d, availability: v ? "in_stock" : "all" }))}
                    label="In stock"
                  />
                  <CB
                    checked={draft.availability === "low_stock"}
                    onChange={(v) => setDraft((d) => ({ ...d, availability: v ? "low_stock" : "all" }))}
                    label="Low Stock"
                  />
                  <CB
                    checked={draft.availability === "out_of_stock"}
                    onChange={(v) => setDraft((d) => ({ ...d, availability: v ? "out_of_stock" : "all" }))}
                    label="Out of stock"
                  />
                </div>
              </div>
